...
from components.cleanup_bigquery_raw_data_intermediate import \
...
from components.cleanup_storage_export_intermediate import \
...
def pipeline_android(
    ...
    add_custom_properties_result = bigquery_add_custom_properties(
